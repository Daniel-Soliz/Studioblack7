...
const INITIAL_CATEGORIES: ProductCategoryItem[] = [
  { id: 'cat-pomadas', name: 'Pomadas', slug: 'pomadas', description: 'Pomadas de alta fixação e efeito matte', status: 'active' },
  { id: 'cat-oleos', name: 'Óleos para barba', slug: 'oleos-para-barba', description: 'Nutrição profunda e hidratação nobre', status: 'active' },
  { id: 'cat-ceras', name: 'Ceras', slug: 'ceras', description: 'Modelagem flexível com brilho controlado', status: 'active' },
  { id: 'cat-shampoos', name: 'Shampoos', slug: 'shampoos', description: 'Limpeza e revigoramento capilar e da barba', status: 'active' },
  { id: 'cat-balm', name: 'Balm para barba', slug: 'balm-para-barba', description: 'Alinhamento dos fios e controle do frizz', status: 'active' },
  { id: 'cat-cabelo', name: 'Produtos para cabelo', slug: 'produtos-para-cabelo', description: 'Finalizadores e tônicos de precisão', status: 'active' },
  { id: 'cat-cuidados', name: 'Cuidados masculinos', slug: 'cuidados-masculinos', description: 'Pós-barba, loções e cuidados faciais', status: 'active' },
  { id: 'cat-acessorios', name: 'Acessórios', slug: 'acessorios', description: 'Pentes de madeira, necessaires e escovas', status: 'active' },
  { id: 'cat-kits', name: 'Kits', slug: 'kits', description: 'Combos exclusivos para o dia a dia masculino', status: 'active' },
];
...
export const INITIAL_SERVICES: ServiceItem[] = [
  ...
  // BARBA
  { id: 'barba', name: 'Barba', price: 'R$ 25,00', priceNumber: 25, category: 'Barba', description: 'Modelagem, desenho com navalha e hidratação da barba.', popular: true, status: 'active', order: 9 },
  ...
  { id: 'progressiva', name: 'Progressiva', price: 'R$ 80,00', priceNumber: 80, category: 'Química / Alisamento', description: 'Tratamento de alinhamento térmico prolongado com brilho e maleabilidade.', status: 'active', order: 14 },
  // COLORAÇÃO
  { id: 'luzes', name: 'Luzes', price: 'R$ 90,00', priceNumber: 90, category: 'Coloração', description: 'Técnica de mechas e pontos de iluminação para destacar o corte.', status: 'active', order: 15 },
  { id: 'nevou', name: 'Nevou', price: 'R$ 130,00', priceNumber: 130, category: 'Coloração', description: 'Descoloração global com platinado de alta pureza e tonalização precisa.', popular: true, status: 'active', order: 16 },
];
...
export const INITIAL_CONTENT: SiteContent = {
  ...
  heroButtonBookingText: 'AGENDAR HORÁRIO',
  ...
  storeBannerUrl: '',
  bookingTitle: 'Agendamento Online Studio Black7',
  bookingSubtitle: 'Escolha o serviço, profissional, data e horário ideais para o seu atendimento.',
...
export const INITIAL_SETTINGS: SiteSettings = {
  ...
  address: 'Tv. União, 4 — Jardim Paulistano — Zona Norte, São Paulo/SP',
  addressStreet: 'Tv. União, 4',
  addressNeighborhood: 'Jardim Paulistano',
  addressCity: 'São Paulo',
  addressState: 'SP',
  addressZipCode: '02814-060',
  referencePoint: 'Próximo à Av. Deputado Cantídio Sampaio',
  mapsUrl: 'https://maps.google.com/?q=Tv.+União,+4+-+Jardim+Paulistano,+São+Paulo+-+SP',
  businessHoursWeekdays: '09h00–12h00 e 13h30–21h00',
  businessHoursSaturday: '09h00–12h00 e 13h30–21h00',
  businessHoursSunday: 'Fechado (Sob agendamento exclusivo)',
  statusNote: 'Segunda a Sábado com agendamento prioritário',
